...
<body class="antialiased font-sans font-light selection:bg-brand-pink selection:text-white relative">
    ...
    <nav class="fixed w-full z-40 transition-all duration-300 py-5" id="navbar">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="flex items-center justify-between">
                <!-- Logo -->
                <a href="{{ route('home') }}" class="flex-shrink-0 font-serif font-bold text-2xl tracking-wide hover:opacity-80 transition-opacity">
                ...
                <div class="hidden lg:flex items-center space-x-8 text-sm tracking-wide">
                    <a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'text-white border-b border-white pb-1' : 'text-gray-400 hover:text-white transition-colors' }}">Home</a>
                    <a href="{{ route('about') }}" class="{{ request()->routeIs('about') ? 'text-white border-b border-white pb-1' : 'text-gray-400 hover:text-white transition-colors' }}">About Us</a>
                    <a href="{{ route('packages') }}" class="{{ request()->routeIs('packages') ? 'text-white border-b border-white pb-1' : 'text-gray-400 hover:text-white transition-colors' }}">Packages</a>
                    <a href="{{ route('business-plan') }}" class="{{ request()->routeIs('business-plan') ? 'text-white border-b border-white pb-1' : 'text-gray-400 hover:text-white transition-colors' }}">Income Plan</a>
                    <a href="{{ route('contact') }}" class="{{ request()->routeIs('contact') ? 'text-white border-b border-white pb-1' : 'text-gray-400 hover:text-white transition-colors' }}">Contact</a>
                    ...
                    <a href="{{ route('register') }}" class="bg-brand-purple hover:bg-brand-pink text-white px-6 py-2.5 rounded-full transition-all">Sign Up</a>
                </div>

                <!-- Hamburger Button (Mobile) -->
                <button id="menu-toggle" class="lg:hidden flex flex-col justify-center items-center w-10 h-10 gap-1.5 focus:outline-none group" aria-label="Toggle Menu">
        ...
        <nav class="flex flex-col gap-2 mt-10">
            <a href="{{ route('home') }}"
               class="group flex items-center justify-between border-b border-white/5 py-5 text-3xl font-serif text-white hover:text-brand-pink transition-colors mobile-link">
                Home
                <svg class="w-5 h-5 text-gray-600 group-hover:text-brand-pink group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
            </a>
            <a href="{{ route('about') }}"
               class="group flex items-center justify-between border-b border-white/5 py-5 text-3xl font-serif text-white hover:text-brand-pink transition-colors mobile-link">
                About Us
    ...
    <footer class="pt-16 pb-12 px-6 lg:px-12 relative border-t border-white/5 bg-black/20 mt-auto">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
                <div class="col-span-2">
                    ...
                    <p class="text-gray-400 font-light max-w-sm mb-8 leading-relaxed">
                        A modern digital platform created with the vision of empowering people through technology, transparency, and community-driven growth.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-gray-400 font-light text-sm">
                        ...
                        <li><a href="{{ route('business-plan') }}" class="hover:text-white transition-colors">Income Plan</a></li>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-xs text-gray-500 font-light tracking-wide">
