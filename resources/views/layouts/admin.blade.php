        ...
        <div class="flex-1 overflow-y-auto py-5 px-3 space-y-6">
            ...
            <div>
                ...
                <div class="space-y-0.5">
                    ...
                    <a href="{{ route('admin.user-investments.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all {{ request()->routeIs('admin.user-investments.*') ? 'nav-active' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                    ...
                    <a href="{{ route('admin.purchases.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all {{ request()->routeIs('admin.purchases.*') ? 'nav-active' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
                        Purchase Requests
                    </a>
                </div>
            </div>
