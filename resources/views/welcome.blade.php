...
@section('content')
    ...
    <section class="min-h-screen relative flex items-center pt-20 overflow-hidden">
        ...
        <div class="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-brand-purple/20 rounded-full blur-[120px] pointer-events-none"></div>
        <div class="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-brand-pink/10 rounded-full blur-[150px] pointer-events-none"></div>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 w-full grid lg:grid-cols-12 gap-12 items-center relative z-10">
            <div class="lg:col-span-7 pr-4 lg:pr-12">
                ...
                <p class="text-lg text-gray-400 max-w-lg mb-12 leading-relaxed font-light">
                    A modern and innovative digital platform created with a singular vision: to foster transparent, community-driven growth in a secure environment.
                </p>
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-8">
                    <a href="#about" class="group flex items-center gap-3 border-b border-white/30 pb-2 hover:border-white transition-colors text-white">
                        <span class="tracking-wide uppercase text-sm">Discover our vision</span>
                        <svg class="w-4 h-4 group-hover:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                    </a>
                </div>
            </div>
            <div class="hidden sm:block lg:col-span-5 relative mt-10 lg:mt-0">
                <div class="image-mask-organic w-full aspect-[4/5] relative bg-white/5 border border-white/10 p-2 shadow-2xl">
                    <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop" alt="Team Collaboration" class="w-full h-full object-cover rounded-[inherit] grayscale-[20%] hover:grayscale-0 transition-all duration-700">
                </div>
    ...
    <section id="about" class="py-32 relative">
        <div class="max-w-4xl mx-auto px-6 lg:px-12 text-center">
            ...
            <div class="prose prose-invert prose-lg mx-auto font-light text-gray-300 leading-relaxed text-left md:text-justify" style="max-width: 65ch;">
                <p class="first-letter:text-7xl first-letter:font-serif first-letter:text-white first-letter:mr-3 first-letter:float-left">
                    Our company focuses on building a strong ecosystem where individuals can explore new opportunities, connect with a global network, and grow together in a secure and sustainable environment.
                </p>
                <p class="mt-8">
                    At AONE APEX ALLIANCE, we believe success becomes more powerful when communities work together with trust, innovation, and a shared purpose. Our platform is designed to provide a smooth, reliable, and future-focused experience for every participant.
                </p>
                <p class="mt-8 italic font-serif text-xl text-white text-center py-8 border-y border-white/10 my-12">
                    "We are committed to creating long-term value through advanced technology, strong leadership, and continuous development."
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="grid md:grid-cols-2 gap-16 md:gap-24">
                ...
                <div class="relative group">
                    <div class="absolute -inset-4 bg-brand-purple/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-400 font-light leading-relaxed text-lg">
                            We envision a world where digital boundaries are erased, empowering individuals from all walks of life to connect, innovate, and thrive within a transparent and supportive ecosystem.
                        </p>
                    </div>
                </div>
                ...
                <div class="relative group mt-12 md:mt-0">
                    <div class="absolute -inset-4 bg-brand-pink/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="relative z-10">
                        <div class="flex items-center gap-4 mb-6">
                        ...
                        <p class="text-gray-400 font-light leading-relaxed text-lg">
                            Our mission is to provide accessible, cutting-edge technology and foster a community-driven platform that prioritizes continuous development, shared success, and unshakeable trust.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-12 gap-16">
                <div class="lg:col-span-5 lg:sticky lg:top-32 h-fit">
                    ...
                    <p class="text-gray-400 font-light leading-relaxed mb-8">
                        To provide a secure, user-friendly, and innovative environment where individuals can participate, grow, and achieve success together.
                    </p>
                ...
                <div class="lg:col-span-7 space-y-4">
                    ...
                    <div class="group flex gap-6 items-start p-6 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/10">
                        <div class="text-2xl text-brand-purple font-serif italic mt-1 group-hover:-translate-y-1 transition-transform">01</div>
                        <div>
                            <h3 class="text-xl text-white mb-2 font-medium">Advanced Solutions</h3>
                            <p class="text-gray-400 font-light text-sm leading-relaxed">Delivering cutting-edge digital solutions tailored for the modern landscape.</p>
                        </div>
                    </div>
                    
                    <div class="group flex gap-6 items-start p-6 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/10">
                        <div class="text-2xl text-brand-purple font-serif italic mt-1 group-hover:-translate-y-1 transition-transform">02</div>
                        <div>
                            <h3 class="text-xl text-white mb-2 font-medium">Supportive Community</h3>
                            <p class="text-gray-400 font-light text-sm leading-relaxed">Creating a strong ecosystem that fosters networking, collaboration, and mutual support.</p>
                        </div>
                    </div>

                    <div class="group flex gap-6 items-start p-6 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/10">
                        <div class="text-2xl text-brand-purple font-serif italic mt-1 group-hover:-translate-y-1 transition-transform">03</div>
                        <div>
                            <h3 class="text-xl text-white mb-2 font-medium">Teamwork & Leadership</h3>
                            <p class="text-gray-400 font-light text-sm leading-relaxed">Encouraging collaborative efforts while nurturing individual leadership capabilities.</p>
                        </div>
                    </div>

                    <div class="group flex gap-6 items-start p-6 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/10">
                        <div class="text-2xl text-brand-purple font-serif italic mt-1 group-hover:-translate-y-1 transition-transform">04</div>
                        <div>
                            <h3 class="text-xl text-white mb-2 font-medium">Transparent Operations</h3>
                            <p class="text-gray-400 font-light text-sm leading-relaxed">Providing clear, honest systems that build trust across our entire user base.</p>
                        </div>
                    </div>

                    <div class="group flex gap-6 items-start p-6 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/10">
                        <div class="text-2xl text-brand-purple font-serif italic mt-1 group-hover:-translate-y-1 transition-transform">05</div>
                        <div>
                            <h3 class="text-xl text-white mb-2 font-medium">Sustainable Growth</h3>
                            <p class="text-gray-400 font-light text-sm leading-relaxed">Building opportunities designed for long-term impact rather than short-term gains.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="why-us" class="py-32 bg-white/[0.02]">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="text-center mb-20">
                ...
                <p class="text-gray-400 font-light max-w-2xl mx-auto">What sets AONE APEX ALLIANCE apart in a crowded digital landscape.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Large featured item -->
                <div class="lg:col-span-2 md:row-span-2 bg-gradient-to-br from-white/[0.04] to-transparent border border-white/5 p-10 rounded-3xl relative overflow-hidden group">
                    <div class="absolute inset-0 bg-brand-purple/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="relative z-10 h-full flex flex-col justify-between">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 font-light text-lg leading-relaxed max-w-md">
                                We focus on transparency, reliability, and long-term sustainability. Our ecosystem is built on a foundation of mutual trust and verifiable actions.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Standard item -->
                <div class="bg-white/[0.02] border border-white/5 p-8 rounded-3xl hover:bg-white/5 transition-colors duration-300">
                    <h3 class="font-serif text-2xl mb-3 text-white">Community Driven</h3>
                    <p class="text-gray-400 font-light text-sm leading-relaxed">
                        Our growing global community is the foundation of our success. We listen, adapt, and build for the people who use our platform.
                    </p>
                </div>
                ...
                <!-- Horizontal item -->
                <div class="md:col-span-2 lg:col-span-3 bg-white/[0.02] border border-white/5 p-8 rounded-3xl flex flex-col sm:flex-row gap-8 items-center hover:bg-white/5 transition-colors duration-300">
                    <div class="flex-1">
                        <h3 class="font-serif text-2xl mb-3 text-white">Growth Opportunities</h3>
                        <p class="text-gray-400 font-light text-sm leading-relaxed">
                            Designed to support personal, professional, and community development at every stage of your journey.
                        </p>
                    </div>
                    <div class="w-full sm:w-px h-[1px] sm:h-32 bg-gradient-to-r sm:bg-gradient-to-b from-brand-pink/50 to-transparent"></div>
                    <div class="flex-1">
                        <h3 class="font-serif text-2xl mb-3 text-white">Future Focused</h3>
                        <p class="text-gray-400 font-light text-sm leading-relaxed">
                            We continuously work towards expansion, innovation, and global impact, ensuring we stay ahead of the curve.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="contact" class="py-32 relative border-t border-white/5 overflow-hidden">
        <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-purple/10 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                <div>
                    ...
                    <p class="text-gray-400 font-light mb-12 text-lg max-w-md">
                        Whether you have a question about our ecosystem, want to explore opportunities, or simply want to connect, we'd love to hear from you.
                    </p>
                    
                    <div class="space-y-8">
                        <div class="flex items-center gap-6">
                            <div class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-brand-pink">
                            ...
                            <div>
                                ...
                                <a href="mailto:hello@aoneapex.com" class="text-white hover:text-brand-pink transition-colors text-lg">hello@aoneapex.com</a>
                            </div>
                        </div>
                        <div class="flex items-center gap-6">
                            <div class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-brand-purple">
                ...
                <div class="bg-white/[0.02] border border-white/5 p-8 md:p-12 rounded-3xl">
                    <form class="space-y-8">
                        <div>
                            <label for="name" class="block text-xs font-medium text-gray-500 uppercase tracking-widest mb-2">Your Name</label>
                            <input type="text" id="name" class="w-full bg-transparent border-b border-white/20 focus:border-brand-pink py-3 text-white placeholder-gray-700 outline-none transition-colors" placeholder="John Doe">
                        </div>
                        <div>
                            <label for="email" class="block text-xs font-medium text-gray-500 uppercase tracking-widest mb-2">Email Address</label>
                            <input type="email" id="email" class="w-full bg-transparent border-b border-white/20 focus:border-brand-pink py-3 text-white placeholder-gray-700 outline-none transition-colors" placeholder="john@example.com">
                        </div>
                        <div>
