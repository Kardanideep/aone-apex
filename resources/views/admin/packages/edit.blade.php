...
@section('title', 'Edit Package | AONE APEX')
...
<div class="mb-6">
    <div class="flex items-center gap-3 mb-1">
        ...
        <div>
            <h1 class="font-serif text-2xl text-slate-800 font-bold">Edit Package</h1>
            <p class="text-slate-500 text-sm">Updating <span class="font-medium text-slate-700">{{ $package->name }}</span></p>
        </div>
    </div>
</div>
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-200">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="status" class="sr-only peer" {{ $package->status ? 'checked' : '' }}>
