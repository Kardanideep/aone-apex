...
@section('title', 'Create User Investment | AONE APEX')
...
<div class="mb-6">
    <div class="flex items-center gap-3 mb-1">
        ...
        <div>
            <h1 class="font-serif text-2xl text-slate-800 font-bold">Create New Investment</h1>
            <p class="text-slate-500 text-sm">Add a new user investment manually.</p>
        </div>
    </div>
</div>
...
<div class="max-w-2xl">
    <div class="admin-card rounded-xl p-8">
        <form action="{{ route('admin.user-investments.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="space-y-6">
